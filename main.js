...
var bot_token = '5492760819:AAFMu5xLWYbQmLS9G9uctqe995jG2I8UuJc'; //YOUR BOT TOKEN HERE

var bot_name = 'Cash_karo_cash_back_bot'; // Bot Name
            ...
            if (flag == channel.length) {
                ...
                if (statdata.length == 0) {
                    ...
                    ctx.reply(
                        ...
                        '<b>📊 Bot Live Stats 📊\n\n📤 Total Payouts : 0 ' + currency + '\n\n💡 Total Users: ' + members.length + ' Users\n\n✅ Created By : <a href="">Kᴏᴍʙᴀɴ »⃟🇮🇳</a></b>' , { parse_mode: 'html', reply_markup: { keyboard: [['💰 Balance'], ['👫 Invite', '🎁 Bonus', '🗂 Wallet'], ['💵 Withdraw', '📊 Statistics']], resize_keyboard: true } }
